...
con_sat_brt_mix	= [lerp(1, col_param[0], obj_timeTracker.night_progress / 10), 
				lerp(1, col_param[1], obj_timeTracker.night_progress / 10), 
				lerp(0, col_param[2], obj_timeTracker.night_progress / 10)];