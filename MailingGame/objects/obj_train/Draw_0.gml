...
draw_sprite_ext(spr_conductorArm, 0, x - 58, y - 65, 1, 1, (((EaseInOutBack(sin(0.005 * pi * wave_anim), 1, 2.3, 1)) * 10 * cos(0.05 * char_anim))) - EaseInOutBack(sin(0.005 * pi * wave_anim), 0, 120, 1), c_white, 1);
}
